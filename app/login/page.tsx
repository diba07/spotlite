    ...
    return (
        <div className="min-h-screen bg-zinc-950 flex flex-col items-center justify-center p-6 selection:bg-indigo-500 selection:text-white">
            <div className="w-full max-w-md">
                ...
                {/* Card */}
                <div className="bg-zinc-900 border border-zinc-800 rounded-[2.5rem] p-8 md:p-10 shadow-2xl relative overflow-hidden">
                    ...
                    <div className="relative z-10">
                        <h1 className="text-4xl font-black text-white mb-2">
                            Hello <span className="font-cursive text-indigo-400 lowercase italic">again!</span>
                        </h1>
                        <p className="text-zinc-400 mb-8 font-medium">Ready to find your next adventure?</p>
                        ...
                        <form onSubmit={handleLogin} className="space-y-4">
                            ...
                            <div className="space-y-2">
                                <div className="flex items-center justify-between ml-1">
                                    ...
                                    <button type="button" className="text-xs font-bold text-indigo-400 hover:text-indigo-300">Forgot?</button>
                                </div>
                                <div className="relative">
